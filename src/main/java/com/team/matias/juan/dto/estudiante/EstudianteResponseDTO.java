...
public class EstudianteResponseDTO {
    ...
    public EstudianteResponseDTO(Long id, String genero, int edad, String apellido, String nombre, 
                                 int dni, String ciudadDeRecidencia, int numeroLibretaUniversitaria, boolean graduado) {
        this.id = id;
        this.genero = genero;
        this.edad = edad;

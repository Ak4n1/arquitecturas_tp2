...
public class CargarDatosDerby {
    ...
    public static void main(String[] args) {
        System.out.println("=== CARGANDO DATOS EN APACHE DERBY ===\n");
        ...
        try {
            ...
            System.out.println("\n✅ DATOS CARGADOS EXITOSAMENTE EN DERBY");
    ...
    private static void cargarCarreras() {
        System.out.println("📚 Cargando carreras de UNICEN en Derby...");
        ...
        System.out.println("\n📊 Total de carreras cargadas en Derby: 14");
    }
